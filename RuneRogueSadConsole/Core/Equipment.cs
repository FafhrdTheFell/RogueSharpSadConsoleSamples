   ...
   public class Equipment : IEquipment, ITreasure, Interfaces.IDrawable
   {
      ...
      public bool PickUp( IActor actor )
      {
         if ( this is HeadEquipment )
         {
            ...
            RogueGame.MessageLog.Add( $"{actor.Name} picked up a {Name} helmet" );
            return true;
         }
         ...
         if ( this is BodyEquipment )
         {
            ...
            RogueGame.MessageLog.Add( $"{actor.Name} picked up {Name} body armor" );
            return true;
         }
         ...
         if ( this is HandEquipment )
         {
            ...
            RogueGame.MessageLog.Add( $"{actor.Name} picked up a {Name}" );
            return true;
         }
         ...
         if ( this is FeetEquipment )
         {
            ...
            RogueGame.MessageLog.Add( $"{actor.Name} picked up {Name} boots" );
            return true;
         }
