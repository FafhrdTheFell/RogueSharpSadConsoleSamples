...
namespace RuneRogueSadConsole.Systems
{
   public class MapGenerator
   {
      ...
      public DungeonMap CreateMap()
      {
         ...
         {
            int roomWidth = RogueGame.Random.Next( _roomMinSize, _roomMaxSize );
            int roomHeight = RogueGame.Random.Next( _roomMinSize, _roomMaxSize );
            int roomXPosition = RogueGame.Random.Next( 0, _width - roomWidth - 1 );
            int roomYPosition = RogueGame.Random.Next( 0, _height - roomHeight - 1 );
